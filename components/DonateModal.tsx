...
export const DonateModal: React.FC<DonateModalProps> = ({
  ...
  return (
    <div className="animate-in fade-in fixed inset-0 z-[100] flex min-h-screen items-center justify-center bg-black/50 p-4 backdrop-blur-sm duration-200">
      <div
        className="animate-in zoom-in-95 relative w-full max-w-md overflow-hidden rounded-2xl bg-white p-6 text-center shadow-xl duration-200 dark:bg-gray-900"
        role="dialog"
        aria-modal="true"
      >
        <button
        ...
        <div className="mb-6 rounded-xl border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
