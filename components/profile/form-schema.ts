...
export const serviceSchema = z.object({
  categoria_id: z.string().min(1, { message: 'Debes seleccionar una categoría.' }),
  nombre: z.string().min(8, { message: 'El título del servicio debe tener al menos 8 caracteres.' }),
  descripcion: z.string().min(10, { message: 'La descripción del servicio debe tener al menos 10 caracteres.' }),
  telefono: z
    .string()
  ...
  direccion: z.string().min(5, { message: 'La dirección es requerida (mínimo 5 caracteres).' }),
