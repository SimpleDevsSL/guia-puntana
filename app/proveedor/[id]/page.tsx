...
// Generar metadatos dinámicos con el nombre del proveedor
...
export default async function ProviderPage({
  ...
  if (profileError || !profile) {
    return notFound(); // Si no existe, mostrar 404
  }

  // 2. Obtener categorías activas (para el filtro)
  ...
  // 3. Construir query de Servicios filtrada por este proveedor
  let query = supabase
    .from('servicios')
    .select(
      `
    ...
    .eq('es_activo', true)
    .eq('estado', true); // Asumiendo que 'estado' también controla visibilidad

  // Aplicar filtros de búsqueda (similares al RPC buscar_servicios)
  if (urlParams.q) {
    // Búsqueda simple por texto en nombre o descripción
    query = query.or(
  ...
  // Intentar obtener un teléfono de contacto de sus servicios (ya que no está en perfiles)
    ...
    <div className="flex min-h-screen flex-col bg-slate-50 font-sans dark:bg-gray-950">
      ...
      <main className="grow pt-16">
          ...
          <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center gap-6 md:flex-row md:items-start md:gap-10">
              ...
              <div className="relative h-32 w-32 shrink-0 overflow-hidden rounded-full border-4 border-white shadow-lg dark:border-gray-800">
                <Image
                  src={profile.foto_url || '/placeholder-user.jpg'}
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                {/* Botón de Contacto (usando el teléfono del primer servicio encontrado) */}
        ...
        <div className="bg-slate-50 dark:bg-gray-950">
          {/* Pasamos basePath para que los filtros funcionen sobre esta URL */}
          <HeroSection
          ...
          <CategoryList
            ...
            activeCategoryId={urlParams.cat || null}
            basePath={`/proveedor/${providerId}`}
          />
